...
1. **Step 1 (Hook / Act 3 Offering):** Diagnose the hiring company's platform risk (such as monolith refactoring, high concurrency, or distributed tracing) and state candidate value as a Staff IC who de-risks complex transitions. When the posting title is Principal, calibrate the language accordingly.
