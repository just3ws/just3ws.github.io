...
**Target Focus:** Merged two attrition-impacted teams into one unified delivery unit in the Acquisition Lane; founded ACQ Enablement to insulate core engineering health, documentation, and PII/fraud remediation from feature roadmap pressure.
