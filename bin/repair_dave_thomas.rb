...
prompt = <<~PROMPT
  You are an expert transcript editor. Below is a monolithic block of interview text between an interviewer (Mike Hall) and an interviewee (Dave Thomas).
  Carefully read the text and separate it into a back-and-forth dialogue using M1 for Mike Hall and S1 for Dave Thomas.
  Mike Hall asks the questions and provides prompts (like "Right.", "Okay."), Dave Thomas gives the answers. 
...
if response.code == "200"
  ...
  begin
    ...
    if parsed_yaml && parsed_yaml["turns"]
      ...
      puts "Successfully restructured Dave Thomas."
    else
