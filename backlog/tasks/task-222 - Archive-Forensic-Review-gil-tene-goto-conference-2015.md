# Archive Forensic Review: Interview with Gil Tene at GOTO Chicago 2015

## Metadata
- **Interview ID**: gil-tene-goto-conference-2015
- **Transcript ID**: gil-tene-goto-conference-2015
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/gil-tene-goto-conference-2015.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/gil-tene-goto-conference-2015.yml`
