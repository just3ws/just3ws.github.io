# Archive Forensic Review: Interview with Alex Rutkowski & Joel Friedman on remote pairing at GOTO Chicago 2014

## Metadata
- **Interview ID**: alex-rutkowski-and-joel-friedman-goto-conference-2014
- **Transcript ID**: alex-rutkowski-and-joel-friedman-goto-conference-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/alex-rutkowski-and-joel-friedman-goto-conference-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/alex-rutkowski-and-joel-friedman-goto-conference-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Alex Rutkowski, Joel Friedman) are correctly attributed.
