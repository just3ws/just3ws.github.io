# Archive Forensic Review: Interview with Evan Light at WindyCityRails 2012

## Metadata
- **Interview ID**: evan-light-windycityrails-2012
- **Transcript ID**: evan-light-windycityrails-2012
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/evan-light-windycityrails-2012.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/evan-light-windycityrails-2012.yml`
