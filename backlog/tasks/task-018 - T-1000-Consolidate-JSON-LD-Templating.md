...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Remove all 10+ json-ld-*.html files from _includes/
- [x] #2 Implement a single unified _includes/schema-factory.html
- [x] #3 All Schema.org validation tests (Google Rich Results, Schema.org Validator) pass for Resume, Article, and Video types
- [x] #4 Site builds successfully without broken include references
<!-- AC:END -->
