# Archive Forensic Review: Interview with Chad Fowler at GOTO Chicago 2015

## Metadata
- **Interview ID**: chad-fowler-goto-conference-2015
- **Transcript ID**: chad-fowler-goto-conference-2015
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/chad-fowler-goto-conference-2015.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/chad-fowler-goto-conference-2015.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Chad Fowler) are correctly attributed.
