# Archive Forensic Review: Interview with Max De Marzi at GOTO Chicago 2015

## Metadata
- **Interview ID**: max-de-marzi-goto-conference-2015
- **Transcript ID**: max-de-marzi-goto-conference-2015
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/max-de-marzi-goto-conference-2015.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/max-de-marzi-goto-conference-2015.yml`
