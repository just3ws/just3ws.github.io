# Archive Forensic Review: Interview with Justin Collins on Brakeman and Rails security at RailsConf 2014

## Metadata
- **Interview ID**: justin-collins-creator-of-brakeman-railsconf-2014
- **Transcript ID**: justin-collins-creator-of-brakeman-railsconf-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/justin-collins-creator-of-brakeman-railsconf-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/justin-collins-creator-of-brakeman-railsconf-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Justin Collins) are correctly attributed.
