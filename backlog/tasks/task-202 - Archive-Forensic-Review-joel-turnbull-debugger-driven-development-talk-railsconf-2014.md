# Archive Forensic Review: Interview with Joel Turnbull on Debugger Driven Development at RailsConf 2014

## Metadata
- **Interview ID**: joel-turnbull-debugger-driven-development-talk-railsconf-2014
- **Transcript ID**: joel-turnbull-debugger-driven-development-talk-railsconf-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/joel-turnbull-debugger-driven-development-talk-railsconf-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/joel-turnbull-debugger-driven-development-talk-railsconf-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Joel Turnbull) are correctly attributed.
