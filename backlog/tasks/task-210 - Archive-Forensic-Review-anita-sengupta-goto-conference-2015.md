# Archive Forensic Review: Interview with Anita Sengupta keynote speaker at GOTO ~Chicago~ Mars 2015

## Metadata
- **Interview ID**: anita-sengupta-goto-conference-2015
- **Transcript ID**: anita-sengupta-goto-conference-2015
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/anita-sengupta-goto-conference-2015.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/anita-sengupta-goto-conference-2015.yml`
