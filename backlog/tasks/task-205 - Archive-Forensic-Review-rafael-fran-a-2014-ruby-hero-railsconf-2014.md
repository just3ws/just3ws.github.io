# Archive Forensic Review: Interview with Rafael Franca on Ruby Hero recognition and community at RailsConf 2014

## Metadata
- **Interview ID**: rafael-fran-a-2014-ruby-hero-railsconf-2014
- **Transcript ID**: rafael-fran-a-2014-ruby-hero-railsconf-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/rafael-fran-a-2014-ruby-hero-railsconf-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/rafael-fran-a-2014-ruby-hero-railsconf-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Rafael França) are correctly attributed.
