# Archive Forensic Review: Interview with Bill Scott at WebVisions 2013

## Metadata
- **Interview ID**: bill-scott-general
- **Transcript ID**: bill-scott-general
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/bill-scott-general.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/bill-scott-general.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Bill Scott) are correctly attributed.
