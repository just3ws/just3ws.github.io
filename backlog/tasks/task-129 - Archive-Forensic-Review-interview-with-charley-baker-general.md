# Archive Forensic Review: Interview with Charley Baker

## Metadata
- **Interview ID**: interview-with-charley-baker-general
- **Transcript ID**: interview-with-charley-baker-general
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/interview-with-charley-baker-general.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/interview-with-charley-baker-general.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Charley Baker) are correctly attributed.
