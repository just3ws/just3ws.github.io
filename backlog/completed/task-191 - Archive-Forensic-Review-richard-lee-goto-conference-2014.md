# Archive Forensic Review: Interview with Richard Lee a contributor to OpenStack at GOTO Chicago 2014

## Metadata
- **Interview ID**: richard-lee-goto-conference-2014
- **Transcript ID**: richard-lee-goto-conference-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/richard-lee-goto-conference-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/richard-lee-goto-conference-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Richard Lee) are correctly attributed.
