# Archive Forensic Review: Interview with Fred George on Programmer Anarchy at GOTO Chicago 2014

## Metadata
- **Interview ID**: fred-george-goto-conference-2014
- **Transcript ID**: fred-george-goto-conference-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/fred-george-goto-conference-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/fred-george-goto-conference-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Fred George) are correctly attributed.
