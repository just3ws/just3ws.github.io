# Archive Forensic Review: Interview with Emily Rosengren on User Groups and ThoughtWorks at GOTO Chicago 2014

## Metadata
- **Interview ID**: emily-rosengren-goto-conference-2014
- **Transcript ID**: emily-rosengren-goto-conference-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/emily-rosengren-goto-conference-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/emily-rosengren-goto-conference-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Emily Rosengren) are correctly attributed.
