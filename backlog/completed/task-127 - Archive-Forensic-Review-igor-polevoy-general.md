# Archive Forensic Review: Building Active Record for Java: Igor Polevoy on JavaLite & Rails Influence

## Metadata
- **Interview ID**: igor-polevoy-general
- **Transcript ID**: igor-polevoy-general
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/igor-polevoy-general.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/igor-polevoy-general.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Igor Polevoy) are correctly attributed.
