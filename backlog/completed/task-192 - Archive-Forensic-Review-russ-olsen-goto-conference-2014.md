# Archive Forensic Review: Interview with Russ Olsen author Eloquent Ruby at GOTO Chicago 2014

## Metadata
- **Interview ID**: russ-olsen-goto-conference-2014
- **Transcript ID**: russ-olsen-goto-conference-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/russ-olsen-goto-conference-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/russ-olsen-goto-conference-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Russ Olsen) are correctly attributed.
