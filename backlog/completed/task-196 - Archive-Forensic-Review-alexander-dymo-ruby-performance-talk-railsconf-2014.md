# Archive Forensic Review: Interview with Alexander Dymo on Ruby performance at RailsConf 2014

## Metadata
- **Interview ID**: alexander-dymo-ruby-performance-talk-railsconf-2014
- **Transcript ID**: alexander-dymo-ruby-performance-talk-railsconf-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/alexander-dymo-ruby-performance-talk-railsconf-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/alexander-dymo-ruby-performance-talk-railsconf-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Alexander Dymo) are correctly attributed.
