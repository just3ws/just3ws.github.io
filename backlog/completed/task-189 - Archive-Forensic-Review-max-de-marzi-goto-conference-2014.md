# Archive Forensic Review: Interview with Max De Marzi organizer Graph DB Chicago at GOTO Chicago 2014

## Metadata
- **Interview ID**: max-de-marzi-goto-conference-2014
- **Transcript ID**: max-de-marzi-goto-conference-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/max-de-marzi-goto-conference-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/max-de-marzi-goto-conference-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Max De Marzi) are correctly attributed.
