# Archive Forensic Review: Directed Practice: Aaron Bedra on Clojure Koans, Technical Writing, and Speaking Mastery

## Metadata
- **Interview ID**: aaron-bedra-general
- **Transcript ID**: aaron-bedra-general
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/aaron-bedra-general.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/aaron-bedra-general.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Aaron Bedra) are correctly attributed.
