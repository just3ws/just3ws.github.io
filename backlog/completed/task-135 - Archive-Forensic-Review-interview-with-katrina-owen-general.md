# Archive Forensic Review: Interview with Katrina Owen

## Metadata
- **Interview ID**: interview-with-katrina-owen-general
- **Transcript ID**: interview-with-katrina-owen-general
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/interview-with-katrina-owen-general.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/interview-with-katrina-owen-general.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Katrina Owen) are correctly attributed.
