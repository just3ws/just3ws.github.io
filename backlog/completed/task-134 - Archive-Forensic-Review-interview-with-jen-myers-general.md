# Archive Forensic Review: Interview with Jen Myers

## Metadata
- **Interview ID**: interview-with-jen-myers-general
- **Transcript ID**: interview-with-jen-myers-general
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/interview-with-jen-myers-general.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/interview-with-jen-myers-general.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Jen Myers) are correctly attributed.
