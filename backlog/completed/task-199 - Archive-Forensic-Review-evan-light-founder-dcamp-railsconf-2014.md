# Archive Forensic Review: Interview with Evan Light on DCamp and developer community building at RailsConf 2014

## Metadata
- **Interview ID**: evan-light-founder-dcamp-railsconf-2014
- **Transcript ID**: evan-light-founder-dcamp-railsconf-2014
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/evan-light-founder-dcamp-railsconf-2014.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/evan-light-founder-dcamp-railsconf-2014.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Evan Light) are correctly attributed.
