# Archive Forensic Review: Interview with Erik Meijer creator Reactive Framework at GOTO Chicago 2013

## Metadata
- **Interview ID**: erik-meijer-creator-reactive-framework-general
- **Transcript ID**: erik-meijer-creator-reactive-framework-general
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/erik-meijer-creator-reactive-framework-general.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/erik-meijer-creator-reactive-framework-general.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Erik Meijer) are correctly attributed.
