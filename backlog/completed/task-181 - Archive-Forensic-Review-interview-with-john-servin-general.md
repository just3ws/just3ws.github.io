# Archive Forensic Review: Interview with John Servin at WebVisions 2013

## Metadata
- **Interview ID**: interview-with-john-servin-general
- **Transcript ID**: interview-with-john-servin-general
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/interview-with-john-servin-general.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/interview-with-john-servin-general.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: John Servin) are correctly attributed.
