# Archive Forensic Review: Interview with Alexandra Masterson at GOTO Chicago 2015

## Metadata
- **Interview ID**: alexandra-masterson-goto-conference-2015
- **Transcript ID**: alexandra-masterson-goto-conference-2015
- **Status**: To Do
- **Priority**: Medium
...
1. **Normalize**: Run `./bin/apply_perfect_transcript_rules.rb _data/transcripts/alexandra-masterson-goto-conference-2015.yml`
2. **Structure**: Run `./bin/structure_transcript_heuristics.rb _data/transcripts/alexandra-masterson-goto-conference-2015.yml`
...
- [ ] Speakers (M1: Mike Hall, S1: Alexandra Masterson) are correctly attributed.
